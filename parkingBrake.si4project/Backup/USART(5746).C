...
void Uart_Print ( u8 speakTask,u8 num )
{
	...
	switch ( speakTask )
	{
        case 1:
            sen_buff[0]=0x2B;
			sen_buff[1]=0x30+gSpe_num/100%10;
			sen_buff[2]=0x30+gSpe_num/10%10;
			sen_buff[3]=0x30+gSpe_num%10;
			sen_buff[4]=0x2C;
            sen_buff[5]=0x30+SpeRinN/100%10;
			sen_buff[6]=0x30+SpeRinN/10%10;
			sen_buff[7]=0x30+SpeRinN%10;
			sen_buff[8]=0x3B;
            break;
